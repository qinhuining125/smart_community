 ...
 */
@Controller
@RequestMapping("/community/GG")
public class ZhsqGgController extends BaseController {
    private String prefix = "community/GG";

    @Autowired
    private IZhsqGgService zhsqGgService;

    @RequiresPermissions("community:GG:view")
    @GetMapping()
    public String GG() {
        return prefix + "/GG";
    }
     ...
     * 查询公告列表
     */
    @RequiresPermissions("community:GG:list")
    @PostMapping("/list")
    @ClearPage
    @ResponseBody
     ...
     * 导出公告列表
     */
    @RequiresPermissions("community:GG:export")
    @PostMapping("/export")
    @ResponseBody
     ...
     * 新增保存公告
     */
    @RequiresPermissions("community:GG:add")
     ...
     * 修改保存公告
     */
    @RequiresPermissions("community:GG:edit")
     ...
     * 删除公告
     */
    @RequiresPermissions("community:GG:remove")
