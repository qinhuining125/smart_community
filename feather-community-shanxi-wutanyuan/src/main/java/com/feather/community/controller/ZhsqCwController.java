 ...
 */
@Controller
@RequestMapping("/community/CW")
public class ZhsqCwController extends BaseController {
    private String prefix = "community/CW";

    @Autowired
    private IZhsqCwService zhsqCwService;

    @RequiresPermissions("community:CW:view")
    @GetMapping()
    public String CW() {
        return prefix + "/CW";
    }
     ...
     * 查询车位列表
     */
    @RequiresPermissions("community:CW:list")
    @PostMapping("/list")
    @ClearPage
    @ResponseBody
     ...
     * 导出车位列表
     */
    @RequiresPermissions("community:CW:export")
    @PostMapping("/export")
    @ResponseBody
     ...
     * 新增保存车位
     */
    @RequiresPermissions("community:CW:add")
     ...
     * 修改保存车位
     */
    @RequiresPermissions("community:CW:edit")
     ...
     * 删除车位
     */
    @RequiresPermissions("community:CW:remove")
