...
import com.feather.community.domain.ZhsqTsjy;
 ...
 */
@Controller
@RequestMapping("/community/TSJY")
public class ZhsqTsjyController extends BaseController {
    private String prefix = "community/TSJY";

    @Autowired
    private IZhsqTsjyService zhsqTsjyService;

    @RequiresPermissions("community:TSJY:view")
    @GetMapping()
    public String TSJY() {
        return prefix + "/TSJY";
    }
     ...
     * 查询投诉建议列表
     */
    @RequiresPermissions("community:TSJY:list")
    @PostMapping("/list")
    @ClearPage
    @ResponseBody
     ...
     * 导出投诉建议列表
     */
    @RequiresPermissions("community:TSJY:export")
    @PostMapping("/export")
    @ResponseBody
     ...
     * 新增保存投诉建议
     */
    @RequiresPermissions("community:TSJY:add")
     ...
     * 修改保存投诉建议
     */
    @RequiresPermissions("community:TSJY:edit")
     ...
     * 删除投诉建议
     */
    @RequiresPermissions("community:TSJY:remove")
