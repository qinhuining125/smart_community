...
import com.feather.community.service.IZhsqZhdjService;
...
public class ZhsqZhdjController extends BaseController {
    ...
    @ResponseBody
    public AjaxResult getZyzList(@Param("xqid") String xqid, @Param("sqid") String sqid, @Param("zyz") String zyz,
            @Param("zyzxx") String zyzxx) {
        Map<String, Object> maps = new HashMap<>();
        maps.put("xqid", xqid);
        maps.put("sqid", sqid);
        maps.put("zyz", zyz);
