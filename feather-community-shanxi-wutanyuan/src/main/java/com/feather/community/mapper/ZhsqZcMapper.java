...
public interface ZhsqZcMapper {
    ...
    public List<Map> getListSb(@Param("sblx") String sblx, @Param("sbmc") String sbmc, @Param("zcid") String zcid,
            @Param("sqid") String sqid, @Param("xqid") String xqid);

    public List<Map> getCljcList(@Param("sqid") String sqid, @Param("xqid") String xqid, @Param("clhm") String clhm,
            @Param("id") String id, @Param("cllx") String cllx);

    public List<Map> getClList(@Param("sqid") String sqid, @Param("xqid") String xqid, @Param("clhm") String clhm,
            @Param("id") String id, @Param("cx") String cx);
