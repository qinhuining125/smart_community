...
public class ZhsqFwServiceImpl implements IZhsqFwService {
    ...
    @Override
    public List<ZhsqFw> selectZhsqFwByLdids(List<String> ldids){
        return zhsqFwMapper.selectZhsqFwByLdids(ldids);
    }

    @Override
    public List<Map<String, String>> selectZhsqFwType(){
        return zhsqFwMapper.selectZhsqFwType();
    }
    ...
    @Override
    public List<Map<String, String>> sqglFwTj(){
        return zhsqFwMapper.sqglFwTj();
    }
}