...
public class FileUploadUtils {
    ...
    public static final String upload(String content, String extension, String url) throws IOException {
        byte[] bytes = content.getBytes(FeatherConstants.UTF8);
    ...
    public static final String getUrl(File file) {
        ...
        url = FeatherConstants.RESOURCE_PREFIX + StringUtils.replace(url, "\\", "/");
        return url;
    }
    ...
    public static final File getFileByUrl(String url, boolean mustExists) {
        ...
        if (StringUtils.isNotEmpty(url)) {
            ...
            String downloadPath = localPath + StringUtils.substringAfter(url, FeatherConstants.RESOURCE_PREFIX);
    ...
    private static final String getUrl(String uploadDir, String fileName) {
        ...
        String url = FeatherConstants.RESOURCE_PREFIX + "/" + currentDir + "/" + fileName;
        return url;
    }
