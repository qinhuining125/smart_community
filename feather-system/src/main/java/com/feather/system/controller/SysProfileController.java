...
public class SysProfileController extends BaseController {
    ...
    public AjaxResult update(SysUser user) {
        ...
        throw new RuntimeException("没有找到要修改的信息");
    }
    ...
    @ResponseBody
    public AjaxResult updateAvatar(@RequestParam("avatarfile") MultipartFile file) throws IOException {
        SysUser currentUser = ShiroUtils.getSysUser();
        if (!file.isEmpty()) {
