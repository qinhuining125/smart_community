    ...
    public AjaxResult batchForceLogout(@RequestParam("ids[]") String[] ids) {
        for (String sessionId : ids) {
            ...
            if (sessionId.equals(ShiroUtils.getSessionId())) {
                throw new RuntimeException("当前登陆用户无法强退");
            }
            onlineSession.setStatus(FeatherConstants.FALSE_FAIL_DISABLED_SUBORDINATE);
            onlineSessionDAO.update(onlineSession);
            online.setStatus(FeatherConstants.FALSE_FAIL_DISABLED_SUBORDINATE);
