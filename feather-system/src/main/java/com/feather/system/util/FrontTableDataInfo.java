package com.feather.system.util;
 ...
 */
public class FrontTableDataInfo implements Serializable {
     ...
     * 表格数据对象
     */
    public FrontTableDataInfo() {

    }

    public FrontTableDataInfo(TableDataInfo tableDataInfo) {
