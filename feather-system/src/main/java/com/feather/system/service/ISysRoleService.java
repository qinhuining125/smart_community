...
public interface ISysRoleService {
     ...
     * @return
     */
    List<SysRole> flagAllByIds(Long[] ids);
     ...
     * @return
     */
    List<SysRole> flagAllByKeys(String[] keys);
     ...
     * @return
     */
    List<SysRole> flagAllByUserId(Long userId);
     ...
     * @return
     */
    List<SysRole> flagAllByResourceId(Long resourceId);
}
