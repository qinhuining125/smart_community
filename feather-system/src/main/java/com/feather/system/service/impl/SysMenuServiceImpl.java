...
public class SysMenuServiceImpl implements ISysMenuService {
    ...
    public int insertMenu(SysMenu menu) {
        ...
        if (menu.getStatus() == null) {
            menu.setStatus(FeatherConstants.TRUE_SUCCESS_ENABLED_PRIMARY);
        }
        // 如果是菜单按钮
    ...
    @Transactional
    @Override
    public int insetPermissionButton(Long parentId, String perms, Integer sort, String menuName) {
        ...
        btn.setStatus(FeatherConstants.TRUE_SUCCESS_ENABLED_PRIMARY);
