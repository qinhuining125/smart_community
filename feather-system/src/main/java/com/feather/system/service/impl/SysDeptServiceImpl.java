...
public class SysDeptServiceImpl implements ISysDeptService {
    ...
    public List<Ztree> initZtree(List<SysDept> deptList, List<String> roleDeptList) {
        ...
        for (SysDept dept : deptList) {
            if (FeatherConstants.TRUE_SUCCESS_ENABLED_PRIMARY.equals(dept.getStatus())) {
    ...
    public int insertDept(SysDept dept) {
        ...
        if (dept.getParentId() != 0) {
            ...
            if (parent != null && !FeatherConstants.TRUE_SUCCESS_ENABLED_PRIMARY.equals(parent.getStatus())) {
        ...
        if (dept.getStatus() == null) {
            dept.setStatus(FeatherConstants.TRUE_SUCCESS_ENABLED_PRIMARY);
        }
        if (parent == null) {
            dept.setDeptLevel(1);
