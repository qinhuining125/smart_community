...
public class PrdAttachmentServiceImpl implements IPrdAttachmentService {
    ...
    public AttachmentInfo upload(MultipartFile file, Boolean thumb, boolean saveDb) {
        ...
        if (saveDb) {
            ...
            String loginUserName = loginUser != null ? loginUser.getLoginName() : null;
            Long loginUserId = loginUser != null ? loginUser.getUserId() : null;
            Date time = new Date();
            prdAttachment.setFileId(uidWorker.getNextId());
            prdAttachment.setCreateBy(loginUserName);
            prdAttachment.setCreateByid(loginUserId);
            prdAttachment.setCreateTime(time);
            prdAttachment.setUpdateBy(loginUserName);
            prdAttachment.setUpdateByid(loginUserId);
