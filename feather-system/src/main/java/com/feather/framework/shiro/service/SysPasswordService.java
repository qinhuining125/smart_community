...
public class SysPasswordService {
    ...
    public void validate(SysUser user, String password, boolean checkPassword) {
        ...
        if (loginRecordCache != null) {
            ...
            if (retryCount.incrementAndGet() > maxRetryCount) {
                AsyncManager.me().execute(AsyncFactory.recordLogininfor(loginName, FeatherConstants.LOGIN_FAIL,
        ...
        if (checkPassword && !matches(user, password)) {
            if (loginRecordCache != null) {
                AsyncManager.me().execute(AsyncFactory.recordLogininfor(loginName, FeatherConstants.LOGIN_FAIL,
    ...
    public boolean matches(SysUser user, String newPassword) {
        ...
        return StringUtils.isEmpty(userPwd)
                || userPwd.equals(encryptPassword(user.getLoginName(), newPassword, user.getSalt()));
    }
