...
public class DataScopeAspect {
    ...
    /** 自定数据权限 */
    public static final Byte DATA_SCOPE_CUSTOM = 2;
    /** 部门数据权限 */
    public static final Byte DATA_SCOPE_DEPT = 3;
    /** 部门及以下数据权限 */
    public static final Byte DATA_SCOPE_DEPT_AND_CHILD = 4;
    /** 仅本人数据权限 */
    public static final Byte DATA_SCOPE_SELF = 5;
    ...
    public static final int DATASOURCE_TYPE_POSTGRESQL = 1;
        ...
        if (defaultDatasourceType == -1) {
            ...
            if (url != null) {
                if (url.indexOf(":postgresql:") != -1) {
                    defaultDatasourceType = DATASOURCE_TYPE_POSTGRESQL;
