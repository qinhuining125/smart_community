...
public class ShiroConfig {
    ...
    public ShiroFilterFactoryBean shiroFilterFactoryBean(SecurityManager securityManager,
        ...
        List<String> anons = shiroUserProperties.getAnon();
        boolean hasAnons = anons != null && anons.size() > 0;
        ...
        // 所有请求
        if (maxSession > 0) {
            filterChainDefinitionMap.put("/**", (hasAnons ? "user," : "") + "kickout,onlineSession,syncOnlineSession");
        } else {
            filterChainDefinitionMap.put("/**", (hasAnons ? "user," : "") + "onlineSession,syncOnlineSession");
        }
